...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full bg-neutral-950 font-sans md:px-10 mb-8"
    >
      {/* Header */}
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-20 pb-5">
        ...
        <p className="text-neutral-400 dark:text-neutral-300 text-sm md:text-base">
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-28 md:top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="absolute left-5 md:left-3 h-6 w-6 md:h-10 md:w-10 rounded-full bg-neutral-900 flex items-center justify-center">
                <div className="h-3 w-3 md:h-4 md:w-4 rounded-full bg-neutral-700 border border-neutral-600" />
              </div>
              <h3 className="hidden md:block text-xl md:pl-20 md:text-4xl font-bold text-gray-200">
                {item.title}
              </h3>
            </div>
            ...
            <div className="relative pl-12 pr-4 md:pl-4 w-full">
              {/* Judul di mobile */}
              <h3 className="md:hidden block text-lg font-bold text-gray-200 mb-2">
                {item.title}
              </h3>
